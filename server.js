...
app.post('/addCharacter', (request, response) => {
    db.collection('characters-and-players').insertOne({
        name: request.body.characterName,
        actor: request.body.actorName, class: request.body.charClass, campaign: request.body.campaign,
        image: request.body.imgUrl, likes: 0
    })
        .then(result => {
